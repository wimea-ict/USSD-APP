...
////////////Needs modification to support other languages on the sectors back button plus sector translations ///////////////
           if($_SESSION['language'] == 'English'){
                $responseMsg .="-0. Back";
            }else if($_SESSION['language'] == 'Luganda'){
        ...
        }else if($menuName == "VoiceEnd"){
            $action ="end";
            if($_SESSION['language'] == 'English'){
                $responseMsg = "Sorry audio is currenly available";
            }else{
                $responseMsg = "Tosonyiwe, obubaka obwe'doboozi tebuliiwo";
            }
        }else{
...
public function availability($msisdn,$sessionId,$entry_data, $with_ad){
    ...
    if(strlen($entry_data)>3){
        if($with_ad == "true"){
            ...
            if(($_SESSION['forecast_for'] == "Seasonal Forecast") || ($_SESSION['forecast_for'] == "Seasonal Forecast no advisory")){
