...
if ( $receiver->getInput() != "") {
    ...
    switch ($_SESSION['menu-Opt']) {
      ...
      case "feedbackdisp":
            ...
            break;
      case "landing_site":
            $_SESSION['menu-Opt'] = $logic->ProcessLandingSite($receiver->getInput(), $sessionId, $msisdn);
            break;
      case "subscription":
            $_SESSION['menu-Opt'] = $logic->ProcessSubscriptionProduct($receiver->getInput(), $sessionId, $msisdn);
            break; 
      case "period":
             $_SESSION['menu-Opt'] = $logic->ProcessSubscriptionPeriod($receiver->getInput(), $sessionId, $msisdn);
            break; 
      case "repeat":
